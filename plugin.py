...
class RemoteCodexAgentPlugin(MaiBotPlugin):
    ...
    async def _run_local_codex_task(
        ...
        try:
            ...
            final_data = {
                ...
                "summary": self._read_local_final_message(final_message_path, stderr_log, process.returncode),
    ...
    def _read_local_final_message(self, final_message_path: Path, stderr_log: Path, returncode: Optional[int]) -> str:
        """读取本地 Codex 最终回答。"""
